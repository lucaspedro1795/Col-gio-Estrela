...
<body>
    ...
    <div class="sp" style="background-image: url(https://www.youbilingue.com.br/blog/wp-content/uploads/2019/06/capa-blog-diferenciar-escola-min.png);background-size: 100%;background-position-y: center;">
            <h1 class="header center indigo-text" style="text-shadow: 3px 3px 3px #fff">Contato</h1>
            <h5 class="center  indigo-text" style="text-shadow: 3px 2px 2px #fff">Entre em contato conosco, por meio do formulário abaixo.</h5>
    ...
    <form class="col s12" action="enviar.php" method="POST">
      <div class="row">
        ...
        <br><br>
        <button type="submit" class="waves-effect waves-light btn right indigo"><i class="material-icons right">send</i>Enviar</button>
      </div>
    </form>
  </div>
        </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5bedd39470ff5a5a3a726188/default';
s1.charset='UTF-8';
