...
<html>
    <head>
        ...
        <title>Acesso Restrito- Colégio Estrela</title>
			...
			<div class="wrap-login100">
					...
					<span class="login100-form-title-1">
						Acesso Restrito
                            ...
                            <form class="login100-form validate-form" action="login_adm.php" method="post">
					<div class="wrap-input100 validate-input m-b-26" data-validate="É necessário o CPF">
                                            <label class="label-input100" for="cpf">CPF:
                                            </label>
