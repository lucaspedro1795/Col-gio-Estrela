...
<html lang="pt/br">
    ...
    <nav class="indigo darken-34" role="navigation">
        <div class="nav-wrapper container"><a id="logo-container" href="#" class="center brand-logo"><img class="logo"
            ...
            <h2 class="indigo-text center">Lançar Frequência de <?php echo $_SESSION['user_nome']; ?></h3>
        ...
        <!-- Ciências -->
            <fieldset>
                ...
                <form action="lançar/edit_cien.php" method="post">
                    ...
                    <label for="">JAN: </label><input type="text" name="pb_c" id="pb_c" value="<?php echo $user['pb_c'] ?>">
                    <br><br>
                    <label for="sb_c">FEV: </label><input type="text" name="sb_c" id="sb_c" value="<?php echo $user['sb_c'] ?>">
                    <br><br>
                    <label for="tb_c">MAR: </label><input type="text" name="tb_c" id="tb_c" value="<?php echo $user['tb_c'] ?>">
                    <br><br>
                    <label for="qb_c">ABR:</label><input type="text" name="qb_c" id="qb_c" value="<?php echo $user['qb_c'] ?>">
                    <br><br>
                    <label for="pb_c">MAI: </label><input type="text" name="pb_c" id="pb_c" value="<?php echo $user['pb_c'] ?>">
                    <br><br>
                    <label for="sb_c">JUN: </label><input type="text" name="sb_c" id="sb_c" value="<?php echo $user['sb_c'] ?>">
                    <br><br>
                    <label for="tb_c">JUL: </label><input type="text" name="tb_c" id="tb_c" value="<?php echo $user['tb_c'] ?>">
                    <br><br>
                    <label for="qb_c">AGO:</label><input type="text" name="qb_c" id="qb_c" value="<?php echo $user['qb_c'] ?>">
                    <br><br>
                    <label for="pb_c">SET: </label><input type="text" name="pb_c" id="pb_c" value="<?php echo $user['pb_c'] ?>">
                    <br><br>
                    <label for="sb_c">OUT: </label><input type="text" name="sb_c" id="sb_c" value="<?php echo $user['sb_c'] ?>">
                    <br><br>
                    <label for="tb_c">NOV: </label><input type="text" name="tb_c" id="tb_c" value="<?php echo $user['tb_c'] ?>">
                    <br><br>
                    <label for="qb_c">DEZ:</label><input type="text" name="qb_c" id="qb_c" value="<?php echo $user['qb_c'] ?>">
                    <br><br>
