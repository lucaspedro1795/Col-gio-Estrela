...
<body>
	...
	try
	{
        ...
        <tr>
            ...
            <th style='background-color:darkblue;'>Nome</th>
            <th style='background-color:darkblue;'>Descrição</th>
            <th style='background-color:darkblue;'>Baixar</th>
            <th style='background-color:darkblue;'>Pré-Visualização</th>
        </tr>
        </thead>
        ");
