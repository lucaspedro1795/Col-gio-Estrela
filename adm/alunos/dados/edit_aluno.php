...
$sql = "UPDATE aluno SET matricula= :matricula, nome= :nome, nascimento= :nascimento, rg= :rg, cpf= :cpf, endereco= :endereco, num_casa= :num_casa, bairro= :bairro, cidade= :cidade, telefone= :telefone, serie= :serie, senha= :senha, email= :email WHERE id = :id";
