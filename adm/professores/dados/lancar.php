...
<html lang="pt/br">
    ...
    <nav class="indigo darken-34" role="navigation">
        <div class="nav-wrapper container"><a id="logo-container" href="#" class="center brand-logo"><img class="logo"
            ...
            <h2 class="indigo-text center">Editar Dados do Professor - <?php echo $_SESSION['user_nome']; ?></h3>
        ...
        <!-- Ciências -->
            <fieldset>
                <form action="edit_prof.php" method="post">
                    ...
                    <a  class="waves-effect waves-light btn indigo" href="../panel_prof_adm.php">Voltar</a>
                </form>
            </fieldset>
