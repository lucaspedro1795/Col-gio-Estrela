    ...
    <nav class="indigo darken-34" role="navigation">
        <div class="nav-wrapper container"><a id="logo-container" href="#" class="center brand-logo"><img class="logo"
            ...
            <ul class="sidenav" id="mobile-demo">
                <li><a href="../panel_prof_adm.php">Início</a></li>
                <li><a href="../adicionar/add_prof.php">Matrícula</a></li>
        ...
        <table width="50%"  border="2">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class='waves-effect waves-light btn indigo' href="lancar.php?id=<?php echo $user['id'] ?>">Editar</a>
                        <a class='waves-effect waves-light btn indigo' href="delete.php?id=<?php echo $user['id'] ?>">Excluir</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
