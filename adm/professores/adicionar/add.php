...
$sql = "INSERT INTO professor (nome,nascimento,rg,cpf,endereco,num_casa,bairro,cidade,telefone,disciplina,senha,email) VALUES (:nome,  :nascimento, :rg, :cpf, :endereco, :num_casa,:bairro,:cidade, :telefone, :disciplina, :senha, :email)";
